...
HUBSPOT_WEBHOOK_CLIENT_SECRET="${HUBSPOT_WEBHOOK_CLIENT_SECRET:-$(read_env_var "$SECRETS_FILE" HUBSPOT_WEBHOOK_CLIENT_SECRET)}"
if [[ -n "$HUBSPOT_WEBHOOK_CLIENT_SECRET" ]]; then
  HUBSPOT_WEBHOOK_SECRET_ID="$(ensure_secret hubspot-webhook-client-secret "$HUBSPOT_WEBHOOK_CLIENT_SECRET")"
  write_state SECRET_ID_HUBSPOT_WEBHOOK_CLIENT_SECRET "$HUBSPOT_WEBHOOK_SECRET_ID"
fi
