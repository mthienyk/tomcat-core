...
export const registerAdminRoutes = (
  ...
  app.post(
    ...
    async (req) => {
      ...
      if (!parsed.success) throw BadRequest("Invalid investor body", { issues: parsed.error.issues });
  ...
  app.post(
    ...
    async (req) => {
      ...
      if (!parsed.success) throw BadRequest("Invalid user body", { issues: parsed.error.issues });
      const user = {
        email: parsed.data.email,
