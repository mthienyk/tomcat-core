...
export const ToolWarningCodes = {
  ...
  DRIVE_BINARY_NOT_EXTRACTABLE: "DRIVE_BINARY_NOT_EXTRACTABLE",
  ...
  DRIVE_DECK_NOT_FOUND: "DRIVE_DECK_NOT_FOUND",
  ...
  DRIVE_INDEX_MISS: "DRIVE_INDEX_MISS",
  DRIVE_LIVE_FALLBACK: "DRIVE_LIVE_FALLBACK",
  BP_FOUND_NON_SPREADSHEET: "BP_FOUND_NON_SPREADSHEET",
  CRM_MEMORY_INDEX_EMPTY: "CRM_MEMORY_INDEX_EMPTY",
  CRM_MEMORY_INDEX_PARTIAL: "CRM_MEMORY_INDEX_PARTIAL",
  NO_SIMILAR_CASES: "NO_SIMILAR_CASES",
  CRM_GREP_NO_MATCHES: "CRM_GREP_NO_MATCHES",
} as const;
